 ...
 */
/**
 * SECTION:element-gstfakedmabufsrc
 *
 ...
 * |[
 * gst-launch-1.0 -v fakedmabufsrc ! "video/x-raw,format=BGRx,width=3440,height=1440" ! vaapipostproc format=nv12 !  vaapih264enc tune=low-power ! filesink location=sample.h264
 * ]|
 * </refsect2>
 */
...
gst_fakedmabufsrc_create (GstPushSrc * psrc, GstBuffer ** outbuf)
{
  ...
  if (GST_VIDEO_INFO_FORMAT (info) != GST_VIDEO_FORMAT_RGBx &&
    ...
    GST_ERROR_OBJECT (fakedmabufsrc, "Unsupported video format");
